...
public class ProfileActivity extends AppCompatActivity {
    ...
    TextView username,email,verifyMsg;
    FirebaseAuth fAuth;
    String userId;
    Button resendCode, resetPassLocal,changeProfileImage, logout;
    FirebaseUser user;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mDatabaseRef.child("users").child("username").setValue(username);
        mDatabaseRef.child("users").child("email").setValue(email);
